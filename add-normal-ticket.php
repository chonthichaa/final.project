...
<head>
    ...
    <title>Add Indian Ticket -  Museum ticket management System</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="" name="">
                                             <div class="form-group">
                                                <label for="exampleInputEmail1">ผู้ใหญ่</label>
                                         ...
                                         <div class="form-group">
                                                <label for="exampleInputEmail1">เด็ก</label>
...
$ret=mysqli_query($con,"select * from tbltickettype where TicketType='Childen'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
